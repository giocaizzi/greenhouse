...
from tuya_irrigation_core.schemas import AlertListResponse, AlertSummary
from tuya_irrigation_server.deps import PlantDbDep, RepoDep, SessionDep
from tuya_irrigation_server.services.alerts import sync_all_alerts, sync_cluster_alerts
